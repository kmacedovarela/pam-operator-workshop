...
1.  In the OpenShift Console, open **Workloads → Config Maps**. ![]({% image_path/operator-lab-config-maps.png %}){:width="650px"}
...
2.  Click on the kebab icon of the `rhpam-trial` KieApp and click **Delete**. ![]({% image_path/operator-lab-rhpam-trial-delete-kie-app.png %}){:width="650px"}

3.  Navigate back to **Workloads → Deployment Configs** and note that the RHPAM Deployment Configs have been removed. ![]({% image_path/operator-lab-rhpam-trial-dc-deleted.png %}){:width="650px"}
